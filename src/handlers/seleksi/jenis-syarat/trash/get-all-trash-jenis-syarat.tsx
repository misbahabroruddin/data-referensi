...
export const useGetAllTrashJenisSyarat = (
  queryParams: QueryParamsJenisSyarat,
) => {
  ...
  const fetchAllJenisSyarat = async () => {
    try {
      const { data } = await axios.get("/seleksi/jenis-syarats/trashs", {
        params,
      });
