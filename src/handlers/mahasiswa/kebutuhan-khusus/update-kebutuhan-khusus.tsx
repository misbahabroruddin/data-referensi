...
export const useUpdateKebutuhanKhusus = (jenisTinggalId: string) => {
  ...
  const onSubmitKebutuhanKhusus = async (form: FormKebutuhanKhusus) => {
    ...
    try {
      const { data } = await axios.put(
        `/mahasiswa/kebutuhan-khususes/${jenisTinggalId}`,
        reqBody,
        {
          headers: {
      ...
      toast.success("Kebutuhan khusus berhasil diperbarui");
