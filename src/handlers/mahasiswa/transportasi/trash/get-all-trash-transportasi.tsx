...
export const useGetAllTrashTransportasi = (
  queryParams: QueryParamsTransportasi,
) => {
  ...
  const fetchAllTransportasi = async () => {
    try {
      const { data } = await axios.get("/mahasiswa/transportasis/trashs", {
        params,
      });
