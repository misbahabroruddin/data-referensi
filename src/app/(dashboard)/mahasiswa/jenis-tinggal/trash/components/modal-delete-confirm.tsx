...
import { useDeleteTrashJenisTinggal } from "@/handlers/mahasiswa/jenis-tinggal/trash/delete-trash-jenis-tinggal";

export const ModalDeleteConfirm = ({ agamaId }: { agamaId: string }) => {
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);

  const { mutateAsync, isPending } = useDeleteTrashJenisTinggal();

  const onDeleteJenisTinggal = async () => {
