...
import { useCreateJenisTinggal } from "@/handlers/mahasiswa/jenis-tinggal/create-jenis-tinggal";

export const ModalAddJenisTinggal: React.FC = () => {
