...
import { useCreateLuaranWajib } from "@/handlers/sippm/luaran-wajib/create-luaran-wajib";

export const ModalAddLuaranWajib: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Luaran Wajib</DialogTitle>
        </DialogHeader>
        <Form {...form}>
