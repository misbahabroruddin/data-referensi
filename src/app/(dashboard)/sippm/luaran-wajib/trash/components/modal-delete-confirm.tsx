...
import { useDeleteTrashLuaranWajib } from "@/handlers/sippm/luaran-wajib/trash/delete-trash-luaran-wajib";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashLuaranWajib();

  const onDeleteLuaranWajib = async () => {
    await mutateAsync(luaranWajibId);
    setIsModalOpen(true);
  };
