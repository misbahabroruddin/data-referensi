...
import { useDeleteTrashRincianBiaya } from "@/handlers/sippm/rincian-biaya/trash/delete-trash-rincian-biaya";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashRincianBiaya();

  const onDeleteRincianBiaya = async () => {
    await mutateAsync(rincianBiayaId);
    setIsModalOpen(true);
  };
