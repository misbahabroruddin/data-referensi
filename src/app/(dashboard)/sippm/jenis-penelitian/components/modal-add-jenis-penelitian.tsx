...
import { useCreateJenisPenelitian } from "@/handlers/sippm/jenis-penelitian/create-jenis-penelitian";

export const ModalAddJenisPenelitian: React.FC = () => {
