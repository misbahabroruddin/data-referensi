...
import { useDeleteTrashJenisPenelitian } from "@/handlers/sippm/jenis-penelitian/trash/delete-trash-jenis-penelitian";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenisPenelitian();

  const onDeleteJenisPenelitian = async () => {
    await mutateAsync(jenisPenelitianId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeleteJenisPenelitian}
              disabled={isPending}
