...
import { useRestoreJenisPenelitian } from "@/handlers/sippm/jenis-penelitian/trash/restore-trash-jenis-penelitian";
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center gap-1">
          ...
          <ModalDeleteConfirm jenisPenelitianId={row.original.id!} />
        </div>
      ),
    },
  ];
