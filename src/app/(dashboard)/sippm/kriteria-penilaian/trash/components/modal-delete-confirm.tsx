...
import { useDeleteTrashKriteriaPenilaian } from "@/handlers/sippm/kriteria-penilaian/trash/delete-trash-kriteria-penilaian";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashKriteriaPenilaian();

  const onDeleteKriteriaPenilaian = async () => {
    await mutateAsync(kriteriaPenilaianId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeleteKriteriaPenilaian}
              disabled={isPending}
