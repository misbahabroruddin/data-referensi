...
import { useDeleteTrashKomponenPenilaian } from "@/handlers/sippm/komponen-penilaian/trash/delete-trash-komponen-penilaian";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashKomponenPenilaian();

  const onDeleteKKomponenPenilaian = async () => {
    await mutateAsync(komponenPenilaianId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeleteKKomponenPenilaian}
              disabled={isPending}
