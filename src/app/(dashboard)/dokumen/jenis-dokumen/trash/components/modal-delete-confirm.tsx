...
import { useDeleteTrashJenisDokumen } from "@/handlers/dokumen/jenis-dokumen/trash/delete-trash-jenis-dokumen";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenisDokumen();

  const onDeleteJenisDokumen = async () => {
    await mutateAsync(jenisDokumenId);
    setIsModalOpen(true);
  };
