...
import { useDeleteTrashKecamatan } from "@/handlers/wilayah/kecamatan/trash/delete-trash-kecamatan";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashKecamatan();

  const onDeleteKecamatan = async () => {
    await mutateAsync(kecamatanId);
    setIsModalOpen(true);
  };
