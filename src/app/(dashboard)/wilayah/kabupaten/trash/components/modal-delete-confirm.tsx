...
import { useDeleteTrashKabupaten } from "@/handlers/wilayah/kabupaten/trash/delete-trash-kabupaten";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashKabupaten();

  const onDeleteKabupaten = async () => {
    await mutateAsync(kabupatenId);
    setIsModalOpen(true);
  };
