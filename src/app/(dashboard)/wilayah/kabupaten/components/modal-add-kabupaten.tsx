...
import { useCreateKabupaten } from "@/handlers/wilayah/kabupaten/create-kabupaten";
import { useSearchProvinsi } from "@/handlers/wilayah/provinsi/search-provinsi";

export const ModalAddKabupaten: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Kabupaten</DialogTitle>
        </DialogHeader>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <SelectComponent
                    ...
                    isDisabled={isLoadingProvinsiOptions}
                    isError={provinsi_id}
                  />
