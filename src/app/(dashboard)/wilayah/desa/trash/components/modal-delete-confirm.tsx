...
import { useDeleteTrashDesa } from "@/handlers/wilayah/desa/trash/delete-trash-desa";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashDesa();

  const onDeleteDesa = async () => {
