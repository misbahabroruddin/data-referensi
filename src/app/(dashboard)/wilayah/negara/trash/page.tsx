...
import { useGetAllTrashNegara } from "@/handlers/wilayah/negara/trash/get-all-trash-negara";
...
export default function TrashNegaraPage() {
  const [queryParams, setQueryParams] =
    useState<QueryParamsNegara>(initialValues);

  const { data, isLoading } = useGetAllTrashNegara(queryParams);
  ...
  return (
    <PageWrapper>
      <Link href="/wilayah/negara" className="mb-2">
        <button
