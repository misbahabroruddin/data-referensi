...
import { useDeleteTrashGelombang } from "@/handlers/pendaftaran/gelombang/trash/delete-trash-gelombang";

export const ModalDeleteConfirm = ({ agamaId }: { agamaId: string }) => {
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);

  const { mutateAsync, isPending } = useDeleteTrashGelombang();

  const onDeleteGelombang = async () => {
