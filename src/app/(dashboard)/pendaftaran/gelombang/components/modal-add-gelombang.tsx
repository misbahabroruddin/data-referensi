...
import { useCreateGelombang } from "@/handlers/pendaftaran/gelombang/create-gelombang";

export const ModalAddGelombang: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Gelombang</DialogTitle>
        </DialogHeader>
        <Form {...form}>
