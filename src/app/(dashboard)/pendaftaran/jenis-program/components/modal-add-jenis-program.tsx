...
import { useCreateJenisProgram } from "@/handlers/pendaftaran/jenis-program/create-jenis-program";
import { Switch } from "@/components/ui/switch";

export const ModalAddJenisProgram: React.FC = () => {
