...
import { useDeleteTrashJenisProgram } from "@/handlers/pendaftaran/jenis-program/trash/delete-trash-jenis-program";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenisProgram();

  const onDeleteJenisProgram = async () => {
    await mutateAsync(jenisProgramId);
    setIsModalOpen(true);
  };
