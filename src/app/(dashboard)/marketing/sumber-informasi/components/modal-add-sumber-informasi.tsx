...
import { useCreateSumberInformasi } from "@/handlers/marketing/sumber-informasi/create-sumber-informasi";

export const ModalAddSumberInformasi: React.FC = () => {
