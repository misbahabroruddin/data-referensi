...
import { useDeleteAgama } from "@/handlers/biodata/agama/delete-agama";
import { ModalDetailAgama } from "./modal-detail-agama";

export const useColumnTable = () => {
  const { mutateAsync, isPending: isLoadingDelete } = useDeleteAgama();
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center gap-1">
          <ModalDetailAgama agamaId={row.original.id!} isEdit />
          <ModalDetailAgama agamaId={row.original.id!} />
          <button
            title="Hapus"
