...
import { useCreateAgama } from "@/handlers/biodata/agama/create-agama";

export const ModalAddAgama: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Agama</DialogTitle>
        </DialogHeader>
        <Form {...form}>
