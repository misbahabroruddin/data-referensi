...
import { useDeleteTrashSuku } from "@/handlers/biodata/suku/trash/delete-trash-suku";

export const ModalDeleteConfirm = ({ agamaId }: { agamaId: string }) => {
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);

  const { mutateAsync, isPending } = useDeleteTrashSuku();

  const onDeleteSuku = async () => {
