...
import { useCreatePenghasilan } from "@/handlers/biodata/penghasilan/create-penghasilan";

export const ModalAddPenghasilan: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Penghasilan</DialogTitle>
        </DialogHeader>
        <Form {...form}>
