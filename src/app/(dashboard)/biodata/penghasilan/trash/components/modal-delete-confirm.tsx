...
import { useDeleteTrashPenghasilan } from "@/handlers/biodata/penghasilan/trash/delete-trash-penghasilan";

export const ModalDeleteConfirm = ({ agamaId }: { agamaId: string }) => {
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);

  const { mutateAsync, isPending } = useDeleteTrashPenghasilan();

  const onDeletePenghasilan = async () => {
