...
import { useDeleteTrashPekerjaan } from "@/handlers/biodata/pekerjaan/trash/delete-trash-pekerjaan";

export const ModalDeleteConfirm = ({ agamaId }: { agamaId: string }) => {
  const [isModalOpen, setIsModalOpen] = useState<boolean>(false);

  const { mutateAsync, isPending } = useDeleteTrashPekerjaan();

  const onDeletePekerjaan = async () => {
