...
import { useCreateJabatanFungsional } from "@/handlers/jabatan/jabatan-fungsional/create-jabatan-fungsional";

export const ModalAddJabatanFungsional: React.FC = () => {
