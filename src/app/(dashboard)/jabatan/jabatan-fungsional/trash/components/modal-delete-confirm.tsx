...
import { useDeleteTrashJabatanFungsional } from "@/handlers/jabatan/jabatan-fungsional/trash/delete-trash-jabatan-fungsional";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJabatanFungsional();

  const onDeleteJabatanFungsional = async () => {
    await mutateAsync(jabatanFungsionalId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeleteJabatanFungsional}
              disabled={isPending}
