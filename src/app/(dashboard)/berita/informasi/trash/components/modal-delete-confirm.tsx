...
import { useDeleteTrashInformasi } from "@/handlers/berita/informasi/trash/delete-trash-informasi";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashInformasi();

  const onDeleteInformasi = async () => {
    await mutateAsync(informasiId);
    setIsModalOpen(true);
  };
