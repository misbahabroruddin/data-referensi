...
import { useCreateJenjangPendidikan } from "@/handlers/pendidikan/jenjang-pendidikan/create-jenjang-pendidikan";

export const ModalAddJenjangPendidikan: React.FC = () => {
