...
import { useRestoreJenjangPendidikan } from "@/handlers/pendidikan/jenjang-pendidikan/trash/restore-trash-jenjang-pendidikan";

export const useColumnTable = () => {
  const { mutateAsync: onRestoreRole, isPending: isLoadingRestore } =
    useRestoreJenjangPendidikan();
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center gap-1">
          ...
          <ModalDeleteConfirm jenjangPendidikanId={row.original.id!} />
        </div>
      ),
    },
  ];
