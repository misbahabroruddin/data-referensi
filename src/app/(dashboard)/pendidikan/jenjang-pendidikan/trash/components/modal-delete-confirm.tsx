...
import { useDeleteTrashJenjangPendidikan } from "@/handlers/pendidikan/jenjang-pendidikan/trash/delete-trash-jenjang-pendidikan";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenjangPendidikan();

  const onDeleteJenjangPendidikan = async () => {
    await mutateAsync(jenjangPendidikanId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeleteJenjangPendidikan}
              disabled={isPending}
