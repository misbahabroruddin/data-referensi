...
import { useDeleteTrashJenisSeleksi } from "@/handlers/seleksi/jenis-seleksi/trash/delete-trash-jenis-seleksi";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenisSeleksi();

  const onDeleteJenisSeleksi = async () => {
    await mutateAsync(jenisSeleksiId);
    setIsModalOpen(true);
  };
