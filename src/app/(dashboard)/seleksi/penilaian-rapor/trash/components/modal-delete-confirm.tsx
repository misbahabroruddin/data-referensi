...
import { useDeleteTrashPenilaianRapor } from "@/handlers/seleksi/penilaian-rapor/trash/delete-trash-penilaian-rapor";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashPenilaianRapor();

  const onDeletePenilaianRapor = async () => {
    await mutateAsync(penilaianRaporId);
    setIsModalOpen(true);
  };
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader className="space-y-4">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Button
              onClick={onDeletePenilaianRapor}
              disabled={isPending}
