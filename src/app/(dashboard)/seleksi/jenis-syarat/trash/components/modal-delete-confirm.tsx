...
import { useDeleteTrashJenisSyarat } from "@/handlers/seleksi/jenis-syarat/trash/delete-trash-jenis-syarat";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashJenisSyarat();

  const onDeleteJenisSyarat = async () => {
    await mutateAsync(jenisSyaratId);
    setIsModalOpen(true);
  };
