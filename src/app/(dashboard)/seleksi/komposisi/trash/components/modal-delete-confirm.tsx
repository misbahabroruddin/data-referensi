...
import { useDeleteTrashKomposisi } from "@/handlers/seleksi/komposisi/trash/delete-trash-komposisi";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashKomposisi();

  const onDeleteKomposisi = async () => {
    await mutateAsync(komposisiId);
    setIsModalOpen(true);
  };
