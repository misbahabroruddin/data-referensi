...
import { useDeleteTrashMataPelajaran } from "@/handlers/seleksi/mata-pelajaran/trash/delete-trash-mata-pelajaran";
...
export const ModalDeleteConfirm = ({
  ...
  const { mutateAsync, isPending } = useDeleteTrashMataPelajaran();

  const onDeleteMataPelajaran = async () => {
    await mutateAsync(mataPelajaranId);
    setIsModalOpen(true);
  };
