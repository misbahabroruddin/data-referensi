...
import { useDeleteSyarat } from "@/handlers/seleksi/syarat/delete-syarat";
import { ModalDetailSyarat } from "./modal-detail-syarat";

export const useColumnTable = () => {
  const { mutateAsync, isPending: isLoadingDelete } = useDeleteSyarat();
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center gap-1">
          <ModalDetailSyarat syaratId={row.original.id!} isEdit />
          <ModalDetailSyarat syaratId={row.original.id!} />
          <button
            title="Hapus"
