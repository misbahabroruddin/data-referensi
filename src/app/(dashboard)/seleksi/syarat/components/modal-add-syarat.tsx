...
import { useCreateSyarat } from "@/handlers/seleksi/syarat/create-syarat";

export const ModalAddSyarat: React.FC = () => {
  ...
  return (
    <Dialog onOpenChange={setIsModalOpen} open={isModalOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-center">Tambah Syarat</DialogTitle>
        </DialogHeader>
        <Form {...form}>
